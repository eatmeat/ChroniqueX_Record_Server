...
## Возможности
- **Аудиозапись**, с возможностью приостановки/продолжения
...
- **Приложение в трее**: Работает в системном трее с удобными элементами управления и индикации
...
Для запуска из исходных кодов используйте команду:
```bash
...
Вы можете настроить генерацию протокола дополнив ее своим промптом, для этого включите пользовательские промпты в настройках и укажите текст, в котором:
...
## Правила для файлов
- файлы в той же директории могут быть включены в контекст по персональным правилам
